...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-productInventories">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.inventory.fields.store') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-productInventories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
